...
export default function SpaDashboard({ stats, userName }: Props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14 }}>
        {[
          { label: 'Sesinoet Sot',        value: fmt(stats.revenue),        color: '#0EA5E9',  sub: 'kuponë fiskalë' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              { label: 'Shto Shërbim', href: '/pos/products', color: '#0EA5E9'   },
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: 20 }}>
          ...
          {[
            { txt: 'TVSH 18% për shërbime spa', color: '#0EA5E9'   },
            { txt: 'Produktet e spa — TVSH 18%', color: '#F59E0B' },
            { txt: 'Rezervimet parapake sigurojnë kapacitet të plotë', color: '#EF4444' },
          ].map((t, i) => (
