...
export default function BarberDashboard({ stats, userName }: Props) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <Link href="/pos" style={{ padding: '9px 16px', borderRadius: 10, background: '#1D4ED8', color:'var(--text-1)', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
            Hap Arkën
          </Link>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14 }}>
        {[
          { label: 'Prerjet Sot',        value: fmt(stats.revenue),        color: '#1D4ED8',  sub: 'kuponë fiskalë' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              { label: 'Shto Shërbim', href: '/pos/products', color: '#1D4ED8'   },
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: 20 }}>
          ...
          {[
            { txt: 'TVSH 18% për shërbime berberi', color: '#1D4ED8'   },
            { txt: 'Produktet e krehjes — TVSH 18%', color: '#F59E0B' },
            { txt: 'Shërbime shtesë rrisin të ardhurat', color: '#EF4444' },
          ].map((t, i) => (
